	...
	class jpeg_compress_struct : jpeg_common_struct
	{
		...
		public void jpeg_set_defaults()
		{
			...
			*/
			...
			// TODO: Why use a default quality here when we know the desired output quality?
		...
		/// <param name="yHsamp">Luma (brightness) horizontal subsampling</param>
		/// <param name="yVsamp">Luma (brightness) vertical subsampling</param>
		/// <param name="cbHsamp">Blue difference horizontal subsampling</param>
		/// <param name="cbVsamp">Blue difference vertical subsampling</param>
		/// <param name="crHsamp">Red difference horizontal subsampling</param>
		/// <param name="crVsamp">Red difference vertical subsampling</param>
		...
		/// <see cref="CompressionParameters">CompressionParameters for common subsample settings</see>
		/// <seealso href="ce3f6712-3633-4a58-af07-626a4fba9ae4.htm" target="_self">Compression parameter selection</seealso>
		/// <seealso href="c90654b9-f3f4-4319-80d1-979c73d84e76.htm" target="_self">Special color spaces</seealso>
		public void jpeg_set_colorspace(J_COLOR_SPACE colorspace,
			int yHsamp = 2, int yVsamp = 2,
			int cbHsamp = 1, int cbVsamp = 1,
			int crHsamp = 1, int crVsamp = 1)
		{
			int ci;
			...
			*/
			...
			switch (colorspace)
			{
				...
				// Note: Not used. RGB input images map to YCbCr by the time they get here.
				...
				// Used to encode RGB and YCbCr source images.
		...
		{
			var out_color_space = map_colorspace(m_in_color_space);
			jpeg_set_colorspace(out_color_space);
			//	default:
