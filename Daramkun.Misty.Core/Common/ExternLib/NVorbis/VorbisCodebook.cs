...
namespace NVorbis
{
    class VorbisCodebook
    {
        ...
        internal void Init(DataPacket packet)
        {
			...
			if ( chkVal != 0x564342UL ) throw new ArgumentException ();
        ...
        void InitTree(DataPacket packet)
        {
			...
			if ( !ComputeCodewords ( sparse, sortedEntries, codewords, codewordLengths, len: Lengths, n: Entries, values: values ) ) throw new ArgumentException ();
