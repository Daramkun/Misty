...
namespace Daramkun.Misty.IO.Compression.Utilities
{
	...
	internal sealed class StaticTree
	{
		...
		static StaticTree ()
		{
			Literals = new StaticTree ( lengthAndLiteralsTreeCodes, Tree.ExtraLengthBits, ZlibConstants.LITERALS + 1, ZlibConstants.L_CODES, ZlibConstants.MAX_BITS );
			Distances = new StaticTree ( distTreeCodes, Tree.ExtraDistanceBits, 0, ZlibConstants.D_CODES, ZlibConstants.MAX_BITS );
			BitLengths = new StaticTree ( null, Tree.extra_blbits, 0, ZlibConstants.BL_CODES, ZlibConstants.MAX_BL_BITS );
		}
