...
namespace Test.Game.PlayAudios
{
	...
	public class Container : Node
	{
		...
		public override void Intro ( params object [] args )
		{
			...
			audio1 = contentManager.Load<IAudioBuffer> ( "Resources/audio1.ogg" );
			audio2 = contentManager.Load<IAudioBuffer> ( "Resources/audio2.ogg" );
			audio3 = contentManager.Load<IAudioBuffer> ( "Resources/audio3.ogg" );
			audio4 = contentManager.Load<IAudioBuffer> ( "Resources/audio4.ogg" );
